class ram_trans_extnd1 extends ram_trans;
  ...
  constraint valid_random_rd {super.rd_address inside {0,4095,1257};}
 constraint valid_random_data{super.data inside {4294};}
 
endclass 

   //extend the ram trans if required to cover all the bins
//class ram_trans_extnd2 extends ram_trans;
//constraint c1 {super.data inside {[4293:4294]};}
//endclass
